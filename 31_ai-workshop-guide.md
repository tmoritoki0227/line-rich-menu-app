...
## はじめに
本記事は、開発未経験者がAIをパートナーとして駆使し、設計指針のみを頼りに自力で「LINE × AWS 家計簿ボット」を完結させるための自律学習用お題です。

AIツールと対話しながら自らの手で実装を進めることで、システム構築のプロセスを自力で完結させる力を養うことを目的としています。そのため、本文では具体的なコードや詳細設計は提示せず、「何を作るか」「何を使うか」という指針のみを示します。

もし途中で行き詰まったときは、[参考doc](https://github.com/tmoritoki0227/line-rich-menu-app/blob/main/09_complete-setup-guide.md)を確認してください。

# 31. AIを使って自力でアプリ作る — LINE × AWS 家計簿ボット（開発未経験者向けのお題）
## はじめに

本記事は、**開発未経験者がAIをパートナーとして自力でシステムを作り上げる**ための自律学習用お題です。

「何を作るか」「何を使うか」という指針のみを示します。具体的なコードや詳細設計はあえて提示しません。AIツールと対話しながら自らの手で実装を進めることで、**システム構築を自力で完結させる力**を養うことを目的としています。

正解は一つではありません。設計や実装方法は自由に決めてかまいません。ぜひ自分なりのアプローチで挑戦してみてください。

行き詰まったときは一人で悩まず、まずAIに聞いてみましょう。それでも解決しない場合は、[参考ドキュメント](https://github.com/tmoritoki0227/line-rich-menu-app/blob/main/09_complete-setup-guide.md)に詳しい手順をまとめてあります。答えを確認しながら進めることも立派な学習です。
